    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.wrapper}>
        <div className={styles.address}>
          <img className={styles.logo} src={logo} width="149" height="25" alt="Логотип Лига банка"/>
          <p>
        ...
        <div className={styles.mobile}>
          <p className={`${styles.title} ${styles.title_mobile}`}>
        ...
        <div className={styles.phone}>
          <p className={`${styles.title} ${styles.title_phone}`}>
            <a className={styles.link} href="tel:88001112233">
              8 800 111 22 33
            </a>
          </p>
        ...
        <ul className={`${styles.list} ${styles.social}`}>
          <li className={styles.social__item}>
            ...
            <a href="/" className={styles.social__link}>
              <svg className="social__icon" width="9" height="16" viewBox="0 0 9 16" fill="none" xmlns="http://www.w3.org/2000/svg">
